...
- (void)commonInit {
    ...
    tagInputField_.layer.borderColor = [UIColor whiteColor].CGColor;
    tagInputField_.backgroundColor = [UIColor colorWithRed:235.0f/255.0f green:235.0f/255.0f blue:235.0f/255.0f alpha:0.0f];
    tagInputField_.delegate = self;
    tagInputField_.font = [UIFont fontWithName:@"Roboto-Bold" size:14];
...
- (void)reloadTagSubviews {
    ...
    UIColor *tagBackgrounColor;
    NSArray *color= [[_tags objectAtIndex:0] componentsSeparatedByString:@" "];
    if([[color objectAtIndex:0] isEqualToString:@"Sold"])
    {
        tagBackgrounColor = _tagsBackgroundColor != nil ? _tagsBackgroundColor : [UIColor colorWithRed:118.0f/255.0f green:178.0f/255.0f blue:230.0f/255.0f alpha:1.0f];
    }else{
        tagBackgrounColor = _tagsBackgroundColor != nil ? _tagsBackgroundColor : [UIColor colorWithRed:95.0f/255.0f green:204.0f/255.0f blue:87.0f/255.0f alpha:1.0f];
    }
...
//    [self reloadTagSubviews];
//    referralListViewController *obj = [[referralListViewController alloc]init];
//    [obj delTag:@""];
    }
