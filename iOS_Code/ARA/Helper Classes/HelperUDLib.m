...
//  HelperApp
//
//  Created by Poonam Parmar on 2/7/15.
...
+(void)setObject:(id)objectvalue forKey:(NSString *)key{
   ...
   // NSData *data =[NSKeyedArchiver archivedDataWithRootObject:objectvalue];
    [[NSUserDefaults standardUserDefaults] setObject:objectvalue forKey:key];
...
+(NSString *)valueForKey:(NSString *)KeyIs{
    NSString * string = [[NSUserDefaults standardUserDefaults]valueForKey:KeyIs];
    return string;
}
