...
- (void) autosizeForWidth {
    ...
    UIFont *font = (IS_IPAD) ? [UIFont fontWithName:@"Roboto-Regular" size:15] : [UIFont fontWithName:@"Roboto-Regular" size:13];
    font = (IS_IPAD_PRO_1366) ? [UIFont fontWithName:@"Roboto-Regular" size:19] : font;
...
-(int)getNoOflines
{
    ...
    CGSize expectedLabelSize = [self.text sizeWithFont:font constrainedToSize:maximumLabelSize lineBreakMode:self.lineBreakMode];
    self.contentMode = UIControlContentVerticalAlignmentTop;
    int numberOfLines = expectedLabelSize.height / [UIFont fontWithName:@"Roboto-Regular" size:15].pointSize;
