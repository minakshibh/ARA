...
- (void)prepare
{
    myTableView = [[UITableView alloc] initWithFrame:CGRectMake(11, 50, 261, 500) style:UITableViewStylePlain];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.itemValue setValue:[NSString stringWithFormat:@"%ld", (long)indexPath.row] forKey:@"rowSelected"];
